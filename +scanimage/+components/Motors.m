...
%             end
    ...
    methods
        ...
        function correctObjectiveResolution(obj,silent)
            ...
            objectiveResolution_ = norm(scanimage.mroi.util.xformPoints([1 1]/sqrt(2),obj.motorToRefTransform,true));
...
function s = defaultMdfSection()
    s = [...
        ...
        makeEntry('motors(1).controllerType','','If supplied, one of {''sutter.mp285'', ''sutter.mpc200'', ''thorlabs.mcm3000'', ''thorlabs.mcm5000'', ''scientifica'', ''pi.e665'', ''pi.e816'', ''npoint.lc40x'', ''bruker.MAMC'',''socketstage''}.')...
