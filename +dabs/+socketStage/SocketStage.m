classdef SocketStage < dabs.interfaces.LinearStageController
    ...
    properties (Abstract,Constant,Hidden)
        nonblockingMoveCompletedDetectionStrategy = 'callback'; % Either 'callback' or 'poll'. If 'callback', this class guarantees that moveDone() will be called when a nonblocking move is complete. See documentation for moveStartHook().
    end
